...
The Dataplex Data Insights Dataset Docunentation scan is a feature in private preview. To proceed with the modules following, if you can get access to the feature, run the commands below that are essentially the results generated by the feature.
