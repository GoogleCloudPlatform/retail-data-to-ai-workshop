...
logger.info("Inside the procurement agent")

root_agent = Agent(
    model=constants.MODEL,
    name="procurement_manager_agent",
    description="An agent that can answer procurement related questions, place purchase orders and run reports.",
    instruction=system_instructions.PROCUREMENT_MANAGER_AGENT_SYSTEM_INSTRUCTIONS,
    tools=[
        tools.sql_generator,
        tools.sql_executor,
        tools.report_generator,
        tools.stock_purchase_order_generator
    ],    
