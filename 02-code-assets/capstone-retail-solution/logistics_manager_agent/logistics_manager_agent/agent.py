...
logger.info("Inside the logistics agent")

root_agent = Agent(
    model=constants.MODEL,
    name="logistics_manager_agent",
    description="An agent that can answer logistics related questions, place stock transfer orders, plan logistics and run canned reports.",
    instruction=system_instructions.LOGISTICS_MANAGER_AGENT_SYSTEM_INSTRUCTIONS,
    tools=[
        tools.sql_generator,
        tools.sql_executor,
        tools.report_generator,
        tools.stock_transfer_order_generator
    ],    
